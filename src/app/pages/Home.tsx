...
export const Home = () => {
  ...
  const brands = [
    {
      name: 'Ferrero Cake',
      description: 'Elegant chocolate creations',
    ...
    },
    {
      ...
      description: 'Traditional artisanal kullaj',
  ...
  return (
    <div className="flex flex-col">
          ...
          <div className="relative group cursor-pointer border-[12px] border-accent rounded-3xl p-4 bg-pink-50 shadow-2xl">
             ...
             <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="font-medium text-accent">Premium Quality</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <Heart className="w-6 h-6 text-secondary" />
                  <span className="font-medium text-accent">Made with Love</span>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <Clock className="w-6 h-6 text-secondary" />
                  <span className="font-medium text-accent">Fresh Daily</span>
                </div>
             </div>
          </div>
        </div>
      ...
      {/* Product Highlight (Store Links) */}
      <section className="py-24 bg-accent text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl font-serif font-bold mb-8">Crafted Perfection</h2>
