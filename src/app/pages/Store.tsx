...
export const Store = () => {
  ...
  const products = [
    ...
    { id: 4, name: 'Turkish baklava', category: 'pastries', brand: 'Kullaj', image: 'https://scontent.famm6-1.fna.fbcdn.net/v/t39.30808-6/486753512_122150023916552292_758922948026539399_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=833d8c&_nc_ohc=vgI-eEjQdLAQ7kNvwE1JHNx&_nc_oc=Adk0yub81RwD_ayo-XY3UG-Hp9QxFMbkZsCSCkSXFAZfDV77pjKzI-c2cG6YXHn8ynMB8nH5ClfJvRQX-bJswLA6&_nc_zt=23&_nc_ht=scontent.famm6-1.fna&_nc_gid=fx9LWYSWtBTGmKBdqO69gQ&oh=00_AfuZQm2r8YenenZK9qsMmdxAeS9bNppsFOuGyETlM3D0Gw&oe=698EDAC8' },
